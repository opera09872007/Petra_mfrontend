!(function () {
  ...
  'function' != typeof Array.prototype.forEach &&
    ...
    Object.defineProperty &&
      ...
      ((t = Object.getOwnPropertyDescriptor(Element.prototype, 'innerText')),
  ...
  var n = function (t, e) {
    ...
    o = function (t) {
      var e = t.selection.getNode(),
        ...
        i =
          'fnoteWrap' == e.className
            ? e.childNodes[0].firstChild.nodeValue.replace(/[^0-9]/g, '')
            : e.childNodes[0];
      r && (o = e.name || decodeURIComponent(e.childNodes[0].getAttribute('data-content')) || ''),
        t.windowManager.open({
          ...
          body: {
            type: 'panel',
            items: [
              { type: 'textarea', name: 'name', multiline: !0, minWidth: 520, minHeight: 100 },
            ],
          },
          buttons: [
          ...
          onSubmit: function (e) {
            var o,
              ...
              l = e.getData().name,
              s =
                '<span class="fnoteWrap" id="#wk_ft{FOOTNOTE_INDEX}" contenteditable="false"><button type="button" class="fnoteBtn" data-content="' +
                encodeURIComponent(l) +
                '">{FOOTNOTE_INDEX}</button></span>',
              ...
              p =
                ...
                (a = function (t) {
                  ...
                  return (e = [].filter.call(t.parentNode.children, function (n) {
                    ...
                    Array.from(e.querySelectorAll('fnoteBtn').length) > 0
                      ? $node.nextElementSibling.classList.contains('fnoteBtn')
                        ? $node.nextElementSibling.children.children
                        : e.querySelectorAll('.fnoteBtn')
                      : 'BODY' === t.nodeName
                      ? []
                      : a(t.parentNode),
                  );
            ...
            if (p.length) {
              ...
              i < u
                ? (o = n(s, { FOOTNOTE_INDEX: $(f[i - 1]).html() }))
                : ((o = n(s, { FOOTNOTE_INDEX: $(f[d]).html() })), t.selection.collapse(0));
            } else (o = n(s, { FOOTNOTE_INDEX: u + 1 })), t.selection.collapse(0);
            t.execCommand('mceInsertContent', !1, o),
              e.close(),
              Array.from(t.getDoc().querySelectorAll('.fnoteBtn')).forEach(function (t, e) {
  ...
  e.add('footnotes', function (t) {
    t.ui.registry.addIcon(
      'fnote',
      '<img src="' + tinyMCE.baseURL + '/plugins/footnotes/img/fn.png">',
    ),
      r.register(t),
      i.register(t);
  });
